...
static int mmc5633_buffer_postenable(struct iio_dev *indio_dev)
{
	...
	int hpower = (data->bw == MMC5633_BW_11_12) ? MMC5633_CTRL2_HPOWER : 0;

	int crtl0_mask = MMC5633_CRTL0_CMM_FREQ_EN;
	int crtl0_value = MMC5633_CRTL0_CMM_FREQ_EN;
	...
	int crtl2_mask = MMC5633_CTRL2_HPOWER| MMC5633_CRTL2_CMM_EN;
	int crtl2_value = hpower | MMC5633_CRTL2_CMM_EN;
